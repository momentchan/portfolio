// Custom Ribbon Tube Shaders
// Renders trails as 3D tubes with proper geometry and lighting

// Custom Ribbon Tube Vertex Shader
export const customRibbonTubeVertexShader = /* glsl */ `
...
// Custom Ribbon Tube Fragment Shader
export const customRibbonTubeFragmentShader = /* glsl */ `
